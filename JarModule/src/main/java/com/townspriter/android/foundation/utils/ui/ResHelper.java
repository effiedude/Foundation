...
import com.townspriter.android.foundation.utils.io.PathUtil;
import com.townspriter.android.foundation.utils.lang.AssertUtil;
import com.townspriter.android.foundation.utils.ui.ResDelegate.IResLocateCallback;
...
public class ResHelper
{
    ...
    @Nullable
    public static InputStream getAssetInputStream(@NonNull String assetName,@Nullable IResLocateCallback locateCallback)
    {
    ...
    @Nullable
    public static InputStream getRawResInputStream(@RawRes int rawResId,@Nullable IResLocateCallback locateCallback)
    {
        InputStream ret=null;
        if(mResDelegate!=null)
        {
