...
public class SystemUtil
{
    ...
    public static String storePageSnapshot(Bitmap bitmap,String tempsnapshotPath,boolean deleteOther)
    {
        ...
        String snapshotPath=com.townspriter.android.foundation.utils.text.StringUtil.isEmpty(tempsnapshotPath)?getSnapshotPath():tempsnapshotPath;
        String snapshotFolder=getSnapshotFolder();
        if(deleteOther)
        {
        ...
        if(am!=null&&needJudgeFgOrBg)
        {
            ...
            if(null!=runningTaskInfos&&runningTaskInfos.size()>0)
            {
                ...
                if(cn!=null&&bn!=null)
                {
                    ...
                    if((com.townspriter.android.foundation.utils.text.StringUtil.isNotEmpty(cnPackageName)&&cnPackageName.equals(context.getPackageName())))
                    {
                        result=APPxSTATExFG;
                    }
                    else
